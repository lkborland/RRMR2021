### spatial UD for animals - Black rockfish DEPTH

## Before
#Black rockfish - 12048
BR.positions.b48 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12048")
...
BR.positions.b50 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12050")
...
BR.positions.b52 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12052")
...
BR.positions.b54 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12054")
...
BR.positions.b56 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12056")
...
BR.positions.b58 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12058")
...
BR.positions.b60 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12060")
...
BR.positions.b62 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12062")
...
BR.positions.b64 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12064")
...
BR.positions.b66 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12066")
...
BR.positions.b68 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12068")
...
BR.positions.b70 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12070")
...
BR.positions.b74 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12074")
...
BR.positions.b76 <- BlackR_depth %>% filter(periods == "Before") %>% filter(Transmitter == "A69-9007-12076")
...
## During
BR.positions.during <- BlackR_depth %>% filter(periods == "During")
...
## After
BR.positions.after <- BlackR_depth %>% filter(periods == "After")
